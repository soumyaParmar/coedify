    ...
    <div className="how">
      ...
      <div className="how2">
        ...
        <div className="how2__right">
          ...
          <ul>
            <li>
              We will handpick the suitable candidates for the job role from our
              pool of pre-screened candidates, then will arrange interview for
              you.
            </li>
            <li>
      ...
      <div className="how3">
        <div className="how3__left">
          <h1 className="how__heading">
            They become part of team, assess the candidates by giving real work
            task.
          </h1>
          <ul>
            <li>
