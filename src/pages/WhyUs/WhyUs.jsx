        ...
        <div className="whycodeify">
          ...
          <div className="whycoedify1">
            ...
            <div className="whycoedify1__right">
              ...
              <p>
                We prioritize transparency in all aspects of our work, from
                billing to project timelines. Our client-centric approach means
                that your goals and needs are at the forefront of every solution
                we provide.
              </p>
            </div>
          </div>
          <div className="whycoedify2">
            <div className="whycoedify2__left">
              ...
              <p>
                With a track record of successfully resolving complex
                engineering challenges and optimizing software systems, we have
                a history of delivering measurable results to our clients.
              </p>
            </div>
          ...
          <div className="whycoedify3">
            ...
            <div className="whycoedify3__right">
              ...
              <p>
                ...
                us apart. We've helped numerous clients reduce their cloud
                expenses while maintaining or improving system performance.
              </p>
            </div>
          </div>
          ...
          <div className="whycoedify5">
            ...
            <div className="whycoedify5__right">
              ...
              <p>
                We stand by our abilities, offering a complimentary service
                period during which we demonstrate our value with tangible
                improvements to your software and infrastructure.
              </p>
            </div>
          </div>
        </div>
